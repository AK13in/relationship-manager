...
with t4:
    ...
    with c1:
        ...
        fig.add_trace(go.Bar(
            ...
            marker_color={"France":TEAL,"Germany":RED,"Spain":AMBER}.values()
            if len(geo_risk)==3 else [RED]*len(geo_risk),
            text=[f"€{v/1e6:.1f}M" for v in geo_risk["Revenue"]],
            textposition="outside",
            marker_color=[{"France":TEAL,"Germany":RED,"Spain":AMBER}.get(g,TEAL)
